...
# convergence <- rhat(fit_half)
# mcmc_rhat(rhat(fit_half))
```

```{r growthhalftrace}
mcmc_trace(as.array(fit_half, pars = c("gmax[1]", "dopt[1]", "ks[1]", "sigma", "sigmaD", "sigmaK")))
```

```{r growthhalfpairs}
mcmc_pairs(as.array(fit_half, pars = c("gmax[1]", "dopt[1]", "ks[1]", "sigma", "sigmaD", "sigmaK"))) 
```
