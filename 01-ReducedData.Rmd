...
To select the best model we first worked on a reduced dataset.
...
save(data, mdata, file = file.path("save", "mdata_reduced.Rdata")) 
```

```{r}
load(file.path("save", "mdata_reduced.Rdata")) 
str(mdata)
```
