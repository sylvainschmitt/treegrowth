...
$$DBH_{y=2020,s,i} - DBH_{y=y0,s,i} \sim logN(log[Gmax_s \times \sum_{y=y0}^{y=2020} exp(-\frac12[\frac{log(\frac{DBH_{y,p,i}}{Dopt_s})}{Ks_s}]^2)], \sigma^2)$$
...
$$Gmax_i = \frac{DBH_{y=2020,s,i}}{\sum_{y=y0}^{y=2020} exp(-\frac12[\frac{log(\frac{DBH_{y,p,i}}{Dopt_s})}{Ks_s}]^2)}$$
