...
```{r traceplota, eval=FALSE}
mcmc_trace(fit, pars = c("thetai1[1]", "thetas1[1]", "sigma[1]", "lp__"), np = nuts_params(fit))
```

```{r pairsa, eval=FALSE}
mcmc_pairs(fit, pars = c("thetai1[1]", "thetas1[1]", "sigma[1]"), np = nuts_params(fit))
```
